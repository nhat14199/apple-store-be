...
exports.MacsService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const macs_1 = require("../../../schemas/macsSchemas/macs");
let MacsService = class MacsService {
    constructor(macModel) {
    ...
    async getMacdetail(_id) {
        const currentData = await this.macModel.find().exec();
        const result = currentData.find((item) => item._id.toString() === _id);
        return result;
    }
};
exports.MacsService = MacsService;
exports.MacsService = MacsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(macs_1.Macs.name)),
